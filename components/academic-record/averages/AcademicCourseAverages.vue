...
export default {
  ...
  data() {
    return {
      headerTitle: this.$t('VIEWS.ACADEMIC_RECORD.ACADEMIC_COURSE_AVERAGES_TABLE.HEADER.TITLE'),
      academicCourseLabel: this.$t('VIEWS.ACADEMIC_RECORD.ACADEMIC_COURSE_AVERAGES_TABLE.ACADEMIC_COURSE.LABEL'),
      subjectAverageLabel: this.$t('VIEWS.ACADEMIC_RECORD.ACADEMIC_COURSE_AVERAGES_TABLE.SUBJECT_AVERAGE.LABEL'),
      creditAverageLabel: this.$t('VIEWS.ACADEMIC_RECORD.ACADEMIC_COURSE_AVERAGES_TABLE.CREDIT_AVERAGE.LABEL'),
    };
  },
  computed: {
